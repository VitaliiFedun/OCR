...
var language = document.querySelector('#langsel').value
...
if (document.getElementById('sourceimage').value=="Source:" ){
    document.getElementById('sourceimage').value="Source: "+input.src;
}
